           ...
           videoPoster: function() {
            ...
            fixedHeaders: function(){
                ...
                var logo = header.find(".site-logo").clone().html(),
                    ...
                    mtnopsMenus = header.find(".mtnops-custom-menus-wrap").clone().html();
                if ($('.right-column').length > 1) {
                    ...
                    var headerClone = [
                        '<div class="sticky-header header-clone mobile_nav_center">',
                            ...
                            '</div>',
                            '<div class="mtnops-custom-menus-wrap">' + mtnopsMenus + '</div>',
                        '</div>',
                    ].join('');
                } else {
                    var headerClone = [
                        '<div class="sticky-header header-clone">',
                            '<div class="container">',
                                ...
                                '<div class="right-column">' + rightColumn + '</div>',
                            '</div>',
                            '<div class="mtnops-custom-menus-wrap cloned-mtnops-menus">' + mtnopsMenus + '</div>',
                        '</div>',
                    ].join('');
                }
